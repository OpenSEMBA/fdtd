...
!!!ahora slanted
      ...
      if (run_with_dmma) then
         ...
         call FinalizeThinSlotSurfacesMM (media%sggMtag, tag_numbers, media%sggMiEx, media%sggMiEy, media%sggMiEz, &
            media%sggMiHx, media%sggMiHy, media%sggMiHz, Alloc_iEx_XI, Alloc_iEx_XE, Alloc_iEx_YI, Alloc_iEx_YE, &
            ...
            Alloc_iHy_ZI, Alloc_iHy_ZE, Alloc_iHz_XI, Alloc_iHz_XE, Alloc_iHz_YI, Alloc_iHz_YE, Alloc_iHz_ZI, Alloc_iHz_ZE, &
            sgg%Med, sgg%NumMedia, BoundingBox)
         !
