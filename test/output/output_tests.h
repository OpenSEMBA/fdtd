...
extern "C" int test_volumic_probe_count_relevant_surfaces();
...
//TEST(output, test_volumic_probe_counter_relevant_surfaces)    {EXPECT_EQ(0, test_volumic_probe_count_relevant_surfaces()); }
