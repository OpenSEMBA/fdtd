...
integer function test_multipolar_expansion_for_lansink_two_wires() bind(C) result(error_cnt)
    ...
    mE%electric(1)%expansion_center = [-0.00497_rkind, 0.0_rkind]
    mE%electric(1)%conductor_potentials = [1.0_rkind, 0.59092722039872780_rkind]
    ...
    mE%electric(2)%expansion_center = [0.0099205134400286565_rkind, 0.0_rkind]
    mE%electric(2)%conductor_potentials = [0.84971105674469871_rkind, 1.0_rkind]
...
integer function test_multipolar_expansion_for_lansink_wire_with_dielectric() bind(C) result(error_cnt)
    ...
    mE%electric(1)%expansion_center = [0.0_rkind, 0.0_rkind]
    mE%electric(1)%conductor_potentials = [1.0_rkind]
    ...
    mE%magnetic(1)%expansion_center = [0.0_rkind, 0.0_rkind]
    mE%magnetic(1)%conductor_potentials = [1.0_rkind]
