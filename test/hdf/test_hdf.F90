integer function test_hdf5_writing_and_reading() bind (C) result(err)

   ! Copied from h5ex_d_fillval

   use hdf5 
   
   implicit none
   
   character(len=*), parameter :: filename = 'testing_hdf5_writing_and_reading.h5'
