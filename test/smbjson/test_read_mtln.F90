...
contains
   function expectedProblemDescription() result (expected)
      ...
      expected%mtln%networks(1)%connections(3)%nodes(1)%termination%termination_type = TERMINATION_sRpLC
      ...
      expected%mtln%networks(1)%connections(5)%nodes(1)%termination%termination_type = TERMINATION_sRpLC
      ...
      expected%mtln%networks(1)%connections(7)%nodes(1)%termination%termination_type = TERMINATION_sRpLC
      ...
      expected%mtln%networks(1)%connections(9)%nodes(1)%termination%termination_type = TERMINATION_sRpLC
