module smbjson_labels_mod
   ...
   character (len=*), parameter :: J_MAT_TERM_TYPE_sRpLC = "sRpLC"
   character (len=*), parameter :: J_MAT_TERM_TYPE_sLpRC = "sLpRC"
   character (len=*), parameter :: J_MAT_TERM_TYPE_sCpLR = "sCpLR"
   character (len=*), parameter :: J_MAT_TERM_TYPE_sRCpL = "sRCpL"
   character (len=*), parameter :: J_MAT_TERM_TYPE_sLCpR = "sLCpR"
   character (len=*), parameter :: J_MAT_TERM_TYPE_sRLpC = "sRLpC"
