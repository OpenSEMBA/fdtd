...
#####################################################
# %% Plot results
lineInt  = Probe(solver.getSolvedProbeFolders("vprobe_LI_7_10_10")[0])
plt.figure()
plt.plot(lineInt['time']*1e9, lineInt['lineIntegral'], '-', label = 'line integral')
plt.grid(which='both')
plt.legend()

# closed  =   Probe(solver.getSolvedProbeFolders("vprobe_LI_7_10_10")[0])
# left  =     Probe(solver.getSolvedProbeFolders("vprobe_left_side_LI_7_10_10")[0])
# right  =    Probe(solver.getSolvedProbeFolders("vprobe_right_side_LI_13_10_12")[0])
# above  =    Probe(solver.getSolvedProbeFolders("vprobe_Rabove_LI_7_10_13")[0])
# ground  =   Probe(solver.getSolvedProbeFolders("vprobe_ground_LI_7_10_10")[0])
# i      =    Probe(solver.getSolvedProbeFolders("current_Wz_13_10_12")[0])
# plt.figure()
