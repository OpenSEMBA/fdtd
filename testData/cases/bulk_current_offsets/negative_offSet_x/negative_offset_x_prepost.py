...
probeL = Probe(solver.getSolvedProbeFolders("Bulk_left")[0])
probeR = Probe(solver.getSolvedProbeFolders("Bulk_right")[0])
probeTotal = Probe(solver.getSolvedProbeFolders("BulkTotal")[0])
