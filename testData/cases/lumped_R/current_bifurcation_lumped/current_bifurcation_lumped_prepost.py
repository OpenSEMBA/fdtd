...
plt.figure()
plt.plot(InitialBulk_probe['time'].to_numpy(), InitialBulk_probe['current'].to_numpy(), label='Initial current', color='blue')
...
plt.figure()
plt.plot(TopBulk_probe['time'].to_numpy(), TopBulk_probe['current'].to_numpy(), label='Current on the top part of the circuit', color='green')
plt.plot(BottomBulk_probe['time'].to_numpy(), BottomBulk_probe['current'].to_numpy(), '--', label='Current on the bottom part of the circuit', color='red')
